package com.julyyu.learn.opengl.book.sample5.sample5_5;
...
import com.julyyu.learn.opengl.book.sample5.sample5_3.Cube;
 ...
 */
public class CubeGLRenderer3 extends GLSurfaceView {
    private SceneRenderer mRenderer;//场景渲染器

    public CubeGLRenderer3(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            cube = new Cube(CubeGLRenderer3.this);
            //打开深度检测
