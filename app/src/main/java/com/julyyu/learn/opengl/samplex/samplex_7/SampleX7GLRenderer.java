package com.julyyu.learn.opengl.samplex.samplex_7;
...
public class SampleX7GLRenderer extends GLSurfaceView {
    ...
    public SampleX7GLRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new SampleX7(SampleX7GLRenderer.this);
            //打开深度检测
