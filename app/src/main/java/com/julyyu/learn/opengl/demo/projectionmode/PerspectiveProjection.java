...
public class PerspectiveProjection {
    ...
    float[] mProjMatrix = new float[16];//4x4矩阵 投影用
    ...
    public PerspectiveProjection(GLSurfaceView mv, float z) {
        this.z = z;
    ...
    public void setSize(Size size) {
        ...
        Matrix.frustumM(
                ...
                0,                //填充起始偏移量
//                -1 * 0.5f, 1* 0.5f,    //near面的left、right
//                -1* 0.5f, 1* 0.5f,    //near面的bottom、top
