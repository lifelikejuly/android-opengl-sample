...
public class LoadedObjectVertexNormalAverage {
    ...
    public LoadedObjectVertexNormalAverage(MixEffectCommonRenderer mv, float[] vertices, float[] normals) {
        //初始化顶点数据
    ...
    //初始化着色器
    public void initShader(MixEffectCommonRenderer mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample10/vertex_light_sample10_1.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample10/frag_light_sample10_1.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
