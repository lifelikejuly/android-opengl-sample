package com.julyyu.learn.opengl.book.sample7.sample7_8;
...
public class Stairs {
    ...
    public Stairs(GLSurfaceView mv) {
        //初始化顶点坐标与着色数据
        initVertexData();
        //初始化着色器
        initShader(mv);
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample7/vertex_sample7_8.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample7/frag_sample7_8.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
