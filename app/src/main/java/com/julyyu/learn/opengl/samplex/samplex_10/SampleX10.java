package com.julyyu.learn.opengl.samplex.samplex_10;
...
public class SampleX10 {
    ...
    public SampleX10(GLSurfaceView mv) {
        //初始化顶点数据的方法
        initVertexData();
        //初始化着色器的方法
        initShader(mv);
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex10/vertex_samplex10.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex10/frag_samplex10.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
    ...
    public void drawSelf(int texId,int index,int width,int height) {
        //指定使用某套shader程序
        ...
        //绑定纹理
        GLES30.glActiveTexture(GLES30.GL_TEXTURE0 + index);//设置使用的纹理编号
