package com.julyyu.learn.opengl.samplex.samplex_12;
...
public class SampleX12 {
    ...
    public SampleX12(GLSurfaceView mv) {
        //初始化顶点数据的方法
        initVertexData();
        //初始化着色器的方法
        initShader(mv);
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex12/vertex_samplex12.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex12/frag_samplex12.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
