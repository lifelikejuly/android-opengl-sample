...
public class SampleX12 {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("samplex12/vertex_samplex12.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("samplex12/frag_samplex12.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
