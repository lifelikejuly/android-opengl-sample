package com.julyyu.learn.opengl.book.sample5.sample5_4;
 ...
 */
public class CubeGLRenderer2 extends GLSurfaceView {
    private SceneRenderer mRenderer;//场景渲染器

    public CubeGLRenderer2(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            cube = new Cube(CubeGLRenderer2.this);
            //打开深度检测
