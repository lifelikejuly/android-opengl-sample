 ...
 */
public class CylinderRenderer extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建圆柱对象
            cylinder = new Cylinder(CylinderRenderer.this, 1, 1.2f, 3.9f, 36, textureId, textureId, textureId);
            //创建圆柱骨架对象
            cylinderl = new CylinderL(CylinderRenderer.this, 1, 1.2f, 3.9f, 36);
