...
public class SampleX9GLRenderer extends GLSurfaceView {
    ...
    int width = 0;
    int height = 0;
    public SampleX9GLRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            SampleX9GLRenderer.this.width = width;
            SampleX9GLRenderer.this.height = height;
            //设置视窗大小及位置
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new SampleX9(SampleX9GLRenderer.this);
            //打开深度检测
