 ...
 */
public class LoadObj5Renderer extends GLSurfaceView {
    ...
    public LoadObj5Renderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            lovo = LoadUtil.loadFromFile5("ch_t.obj", LoadObj5Renderer.this.getResources(), LoadObj5Renderer.this);
            //加载纹理
