package com.julyyu.learn.opengl.book.sample7.sample7_4;
 ...
 */
public class TextureMapSampleRenderer extends GLSurfaceView {
    ...
    public TextureMapSampleRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建纹理矩形对象
            texRect = new TextureRect(TextureMapSampleRenderer.this);
            //打开深度检测
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            switch (num) {
                case 0:
                    currenttexId32 = texId[0];
                    currenttexId256 = texId[4];
                    break;
                case 1:
                    currenttexId32 = texId[1];
                    currenttexId256 = texId[5];
                    break;
                case 2:
                    currenttexId32 = texId[2];
                    currenttexId256 = texId[6];
                    break;
                case 3:
                    currenttexId32 = texId[3];
                    currenttexId256 = texId[7];
                    break;
            }
        }
