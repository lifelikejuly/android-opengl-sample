 ...
 *
 */
public class TextureMapGLView3 extends GLSurfaceView {
    ...
    public TextureMapGLView3(Context context) {
        super(context);
        ...
        setRenderer(new Renderer() {
            ...
            public void onSurfaceChanged(GL10 gl, int width, int height) {
                ...
                TextureMapGLView3.this.width = width;
                TextureMapGLView3.this.height = height;
