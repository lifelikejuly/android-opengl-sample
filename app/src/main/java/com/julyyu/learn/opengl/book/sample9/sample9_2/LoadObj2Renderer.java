 ...
 */
public class LoadObj2Renderer extends GLSurfaceView {
    ...
    public LoadObj2Renderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            lovo = LoadUtil.loadFromFile2("book/sample9/ch1.obj", LoadObj2Renderer.this.getResources(), LoadObj2Renderer.this);
        }
    }
}
