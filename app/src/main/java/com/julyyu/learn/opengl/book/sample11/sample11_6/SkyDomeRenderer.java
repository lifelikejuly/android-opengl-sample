package com.julyyu.learn.opengl.book.sample11.sample11_6;
...
public class SkyDomeRenderer extends GLSurfaceView {
    ...
    public SkyDomeRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            Constant.yArray = Constant.loadLandforms(SkyDomeRenderer.this.getResources(), R.drawable.land);

            mountion = new Mountion(SkyDomeRenderer.this, Constant.yArray, Constant.yArray.length - 1, Constant.yArray[0].length - 1);
            sky = new Sky(SkyDomeRenderer.this);
            //初始化纹理
    ...
    public int initTexture(int drawableId, boolean isMipmap) {
        ...
        if (isMipmap) {//若标志位为true，则将采用方式设置为MipMap系列
            //设置MAG纹理采样方式
        ...
        } else {//若标志位为false，则将采用方式设置为普通采样系列
            //设置MAG纹理采样方式
