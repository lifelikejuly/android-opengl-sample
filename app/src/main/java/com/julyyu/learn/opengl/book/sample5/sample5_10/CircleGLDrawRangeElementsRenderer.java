package com.julyyu.learn.opengl.book.sample5.sample5_10;
 ...
 */
public class CircleGLDrawRangeElementsRenderer extends GLSurfaceView {

    private SceneRenderer mRenderer;//场景渲染器

    public CircleGLDrawRangeElementsRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建圆对象
            circle = new Circle(CircleGLDrawRangeElementsRenderer.this);
            //打开深度检测
