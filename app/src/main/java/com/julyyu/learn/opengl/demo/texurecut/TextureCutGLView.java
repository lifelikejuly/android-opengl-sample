package com.julyyu.learn.opengl.demo.texurecut;
...
import com.julyyu.learn.opengl.util.GLESShellUtils;
 ...
 * description：
 */
public class TextureCutGLView extends GLSurfaceView {

    SceneRenderer mRenderer;


    public TextureCutGLView(Context context) {
        super(context);
...
//        private final float[] mViewMatrix = new float[16];
        ...
        public void initTexture() {
            ...
            //通过输入流加载图片===============begin===================
            InputStream is = context.getResources().openRawResource(R.raw.i900x1600);
            try {
