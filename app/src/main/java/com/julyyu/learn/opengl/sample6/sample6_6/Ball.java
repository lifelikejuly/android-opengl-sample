package com.julyyu.learn.opengl.sample6.sample6_6;
...
public class Ball {
    ...
    public void initShader(GLSurfaceView mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_sample6_6.vsh",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_sample6_6.sh",
                mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
