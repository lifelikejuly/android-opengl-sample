 ...
 */
public class VertexAttribRenderer extends GLSurfaceView {
    ...
    public VertexAttribRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            for (int i = 0; i < ha.length; i++) {//创建六角星数组中的各个对象
                ha[i] = new SixPointedStar(VertexAttribRenderer.this, 0.4f, 1.0f, -1.0f * i, color[i]);
            }
