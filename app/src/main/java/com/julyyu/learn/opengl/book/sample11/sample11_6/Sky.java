...
public class Sky {
    ...
    public void initShader(SkyDomeRenderer mv) {
        String mVertexHandle = ShaderUtil.loadFromAssetsFile("book/vertex_tex.sh", mv.getResources());
        String mTexCoorHandle = ShaderUtil.loadFromAssetsFile("book/frag_tex.sh", mv.getResources());
