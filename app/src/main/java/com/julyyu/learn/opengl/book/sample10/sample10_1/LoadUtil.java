...
public class LoadUtil {
    ...
    public static LoadedObjectVertexNormalAverage loadFromFileVertexOnlyAverage(String fname, Resources r, MixEffectCommonRenderer mv) {
        //加载后物体的引用
    ...
    public static LoadedObjectVertexNormalFace loadFromFileVertexOnlyFace(String fname, Resources r, MixEffectCommonRenderer mv) {
        //加载后3D对象的引用
