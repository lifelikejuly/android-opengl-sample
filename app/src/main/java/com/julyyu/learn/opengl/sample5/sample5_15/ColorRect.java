package com.julyyu.learn.opengl.sample5.sample5_15;
...
public class ColorRect {
    ...
    public ColorRect(GLSurfaceView mv, float[] color) {
        //初始化顶点坐标与着色数据
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_sample5_15.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_sample5_15.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
