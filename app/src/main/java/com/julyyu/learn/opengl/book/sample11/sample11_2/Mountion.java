package com.julyyu.learn.opengl.book.sample11.sample11_2;
...
public class Mountion {
    ...
    public Mountion(TerrainRenderer mv, float[][] yArray, int rows, int cols) {
    ...
    //初始化着色器的方法
    public void initShader(TerrainRenderer mv) {
        String mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample11/vertex_sample11_2.sh", mv.getResources());
        String mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample11/frag_sample11_2.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
