...
public class TreeForDraw
{
    ...
    int vCount=0;   
    public TreeForDraw(SignBoardRenderer mv)
    {
    	initVertexData();
    	initShader(mv);
    }
    ...
    {
    	//加载顶点着色器的脚本内容
        String mVertexShader= ShaderUtil.loadFromAssetsFile("book/sample11/vertex_sample11_1.sh", mv.getResources());
        //加载片元着色器的脚本内容
        String mFragmentShader=ShaderUtil.loadFromAssetsFile("book/sample11/frag_sample11_1.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
