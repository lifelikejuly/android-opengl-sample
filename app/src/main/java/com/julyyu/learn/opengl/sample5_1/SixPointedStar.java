...
public class SixPointedStar {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_sample5_1.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_sample5_1.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
