...
public class TerrainRenderer extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            Constant.yArray = Constant.loadLandforms(TerrainRenderer.this.getResources(), R.drawable.land);

            mountion = new Mountion(TerrainRenderer.this, Constant.yArray, Constant.yArray.length - 1, Constant.yArray[0].length - 1);
            //加载山地地形草皮纹理
