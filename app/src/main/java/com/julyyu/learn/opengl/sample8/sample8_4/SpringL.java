package com.julyyu.learn.opengl.sample8.sample8_4;
...
public class SpringL {
    ...
    public SpringL(GLSurfaceView mv,
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_color_sample8_3.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_color_sample8_3.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
