...
public class SampleX14GLRenderer extends GLSurfaceView {
    ...
    int width = 0;
    int height = 0;
    public SampleX14GLRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            SampleX14GLRenderer.this.width = width;
            SampleX14GLRenderer.this.height = height;
            //设置视窗大小及位置
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new SampleX14(SampleX14GLRenderer.this);
            //初始化纹理
            initTexture();
            //关闭背面剪裁
