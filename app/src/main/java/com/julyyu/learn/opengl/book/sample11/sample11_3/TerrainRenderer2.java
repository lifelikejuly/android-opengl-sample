package com.julyyu.learn.opengl.book.sample11.sample11_3;
...
public class TerrainRenderer2 extends GLSurfaceView {
    ...
    public TerrainRenderer2(Context context) {
        super(context);
        Constant.LAND_HIGH_ADJUST = 2f;
        Constant.LAND_HIGHEST = 40f;
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            Constant.yArray = Constant.loadLandforms(TerrainRenderer2.this.getResources(), R.drawable.land);

            mountion = new Mountion(TerrainRenderer2.this, Constant.yArray, Constant.yArray.length - 1, Constant.yArray[0].length - 1);
            //初始化纹理
