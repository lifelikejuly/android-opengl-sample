package com.julyyu.learn.opengl.sample6_8;
...
import com.julyyu.learn.opengl.sample6_7.Sample6_7Renderer;
 ...
 */
public class Sample6_8Renderer extends GLSurfaceView {
    ...
    public Sample6_8Renderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            cube = new Cube(Sample6_8Renderer.this);
            //打开深度检测
