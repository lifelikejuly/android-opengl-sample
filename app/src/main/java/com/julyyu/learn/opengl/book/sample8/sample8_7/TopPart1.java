...
import com.julyyu.learn.opengl.book.sample8.BezierUtil;
...
public class TopPart1 {
    ...
    public TopPart1(GLSurfaceView mv, float scale, int nCol, int nRow) {
        this.scale = scale;
    ...
    public void initVertexData(float scale, int nCol, int nRow
        ...
        for (int i = 0; i < nRow + 1; i++) {//根据得到的曲线上点的列表生成旋转面上点的坐标列表
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample8/vertex_tex_sample8_7.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample8/frag_tex_sample8_7.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
