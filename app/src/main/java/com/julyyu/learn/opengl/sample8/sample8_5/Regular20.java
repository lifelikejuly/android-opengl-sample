package com.julyyu.learn.opengl.sample8.sample8_5;
...
public class Regular20 {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_tex_light.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_tex_light.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
