 ...
 */
public class PointNormalVectorRenderer extends Sample6Renderer {

    private SceneRenderer mRenderer;//场景渲染器
    Cube cube;//立方体

    public PointNormalVectorRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            cube = new Cube(PointNormalVectorRenderer.this);
            //打开深度检测
