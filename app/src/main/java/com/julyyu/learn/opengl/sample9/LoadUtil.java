...
import com.julyyu.learn.opengl.sample9.sample9_1.LoadedObjectVertexOnly;
import com.julyyu.learn.opengl.sample9.sample9_2.LoadedObjectVertexNormal;
import com.julyyu.learn.opengl.sample9.sample9_3.LoadedObjectVertexNormal2;
import com.julyyu.learn.opengl.sample9.sample9_4.LoadedObjectVertexNormalTexture;
import com.julyyu.learn.opengl.sample9.sample9_5.LoadedObjectVertexNormalTexture2;
import com.julyyu.learn.opengl.sample9.sample9_6.LoadedObjectVertexNormal3;
...
public class LoadUtil {
    ...
    //从obj文件中加载携带顶点信息的物体
    public static LoadedObjectVertexNormalTexture2 loadFromFile5(String fname, Resources r, GLSurfaceView mv) {
        //加载后物体的引用
    ...
    public static LoadedObjectVertexOnly loadFromFile(String fname, Resources r, GLSurfaceView mv) {
    ...
    public static LoadedObjectVertexNormal loadFromFile2(String fname, Resources r, GLSurfaceView mv) {//从obj文件中加载仅携带顶点信息的物体，并计算面法向量
    ...
    public static LoadedObjectVertexNormal2 loadFromFile3(String fname, Resources r, GLSurfaceView mv) {
        //加载后物体的引用
        LoadedObjectVertexNormal2 lo = null;
        //原始顶点坐标列表--直接从obj文件中加载
        ArrayList<Float> alv = new ArrayList<Float>();
        ...
        try {
            ...
            int c = 0;//法向量数组索引
            for (Integer i : alFaceIndex) {//对结果序列中每个顶点的编号循环
            ...
            //创建加载物体对象
            lo = new LoadedObjectVertexNormal2(mv, vXYZ, nXYZ);
        } catch (Exception e) {
            Log.d("load error", "load error");
            e.printStackTrace();
        }
    ...
    //从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的平均法向量
    public static LoadedObjectVertexNormalTexture loadFromFile4
    ...
    //从obj文件中加载携带顶点信息的物体，并自动计算每个顶点的平均法向量
    public static LoadedObjectVertexNormal3 loadFromFile6(String fname, Resources r, GLSurfaceView mv) {
        //加载后物体的引用
        LoadedObjectVertexNormal3 lo = null;
        //原始顶点坐标列表--直接从obj文件中加载
        ArrayList<Float> alv = new ArrayList<Float>();
        //结果顶点编号列表--根据面的信息从文件中加载
        ArrayList<Integer> alFaceIndex = new ArrayList<Integer>();
        ...
        try {
            ...
            //创建加载物体对象
            lo = new LoadedObjectVertexNormal3(mv, vXYZ, nXYZ);
        } catch (Exception e) {
            Log.d("load error", "load error");
            e.printStackTrace();
        }
