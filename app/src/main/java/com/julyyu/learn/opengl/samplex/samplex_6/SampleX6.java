...
public class SampleX6 {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex6/vertex_samplex6.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex6/frag_samplex6.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
