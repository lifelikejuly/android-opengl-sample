package com.julyyu.learn.opengl.book.sample6.sample6_4;
 ...
 */
public class SpeculaRenderer extends Sample6Renderer {

    private SceneRenderer mRenderer;//场景渲染器
    Ball ball;//球
    float lightOffset = -4;//灯光的位置或方向的偏移量

    public SpeculaRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new Ball(SpeculaRenderer.this);
            //打开深度检测
