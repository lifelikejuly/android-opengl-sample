...
public class TerrainRenderer3 extends GLSurfaceView {
    ...
    public TerrainRenderer3(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            Constant.yArray = Constant.loadLandforms(TerrainRenderer3.this.getResources(), R.drawable.land);

            mountion = new Mountion(TerrainRenderer3.this, Constant.yArray, Constant.yArray.length - 1, Constant.yArray[0].length - 1);
            //初始化纹理
