package com.julyyu.learn.opengl.book.sample6.sample6_10;
 ...
 */
public class Sample6_10Renderer extends Sample6Renderer {

    private SceneRenderer mRenderer;//场景渲染器
    Ball ball;//球

    public Sample6_10Renderer(Context context) {
        super(context);
    ...
    protected void touchEventCallback(double y, double x) {
        ...
        ball.yAngle += y;//设置填充椭圆绕y轴旋转的角度
        ball.xAngle += x;//设置填充椭圆绕x轴旋转的角度
    }
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new Ball(Sample6_10Renderer.this);
            //打开深度检测
