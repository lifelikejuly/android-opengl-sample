...
public class ColorRect {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample5/vertex_sample5_15.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample5/frag_sample5_15.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
