 ...
 */
public class TextureMapGreenRenderer extends GLSurfaceView {
    ...
    public TextureMapGreenRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new Triangle(TextureMapGreenRenderer.this);
            //打开深度检测
