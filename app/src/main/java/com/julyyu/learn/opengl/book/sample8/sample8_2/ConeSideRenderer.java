 ...
 */
public class ConeSideRenderer extends GLSurfaceView {
    ...
    public ConeSideRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建圆锥对象
            cone = new Cone(ConeSideRenderer.this, 1, 1.6f, 3.9f, 36, textureId, textureId);
            //创建圆锥骨架对象
            conel = new ConeL(ConeSideRenderer.this, 1, 1.6f, 3.9f, 36);
