package com.julyyu.learn.opengl.book.sample9.sample9_4;
 ...
 */
public class LoadObj4Renderer extends GLSurfaceView {
    ...
    public LoadObj4Renderer(Context context) {
        super(context);
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                if (currentTextureId == textureId2) {
                    currentTextureId = textureId;
                } else {
                    currentTextureId = textureId2;
                }
                break;
        }
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onDrawFrame(GL10 gl) {
            ...
            if (lovo != null) {
                ...
                lovo.drawSelf(currentTextureId);
            }
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            lovo = LoadUtil.loadFromFile4("book/sample9/ch_t.obj", LoadObj4Renderer.this.getResources(), LoadObj4Renderer.this);
            //加载纹理图
            textureId = initTexture(R.drawable.ghxp);
            textureId2 = initTexture(R.drawable.qhc);
            currentTextureId = textureId;
        }
    }
