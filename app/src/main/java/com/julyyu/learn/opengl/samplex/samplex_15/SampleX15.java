...
public class SampleX15 {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex15/vertex_samplex15.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex15/frag_samplex15.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
