package com.julyyu.learn.opengl.book.sample8.sample8_2;
...
public class ConeSide {
    ...
    public ConeSide(GLSurfaceView mv, float scale, float r, float h, int n) {
    ...
    public void initVertexData(
        ...
        for (float angdeg = 0; Math.ceil(angdeg) < 360; angdeg += angdegSpan) {//按照一定的角度跨度切分
        ...
        for (int i = 0; i < vertices.length; i = i + 3) {//法向量数据的初始化
            //如果当前的顶点为圆锥的最高点
