 ...
 *
 */
public class TextureMapGLOverLayView extends GLSurfaceView {
    ...
    public TextureMapGLOverLayView(Context context) {
        super(context);
        ...
        setRenderer(new Renderer() {
            ...
            public void onSurfaceChanged(GL10 gl, int width, int height) {
                ...
                TextureMapGLOverLayView.this.width = width;
                TextureMapGLOverLayView.this.height = height;
