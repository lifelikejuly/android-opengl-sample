...
public class SampleX5GLRenderer extends GLSurfaceView {
    ...
    public SampleX5GLRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new SampleX5(SampleX5GLRenderer.this);
            //打开深度检测
