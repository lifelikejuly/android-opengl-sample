...
public class ConeSideL {
    ...
    public ConeSideL(GLSurfaceView mv, float scale, float r, float h, int n) {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample8/vertex_color_light.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample8/frag_color_light.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
