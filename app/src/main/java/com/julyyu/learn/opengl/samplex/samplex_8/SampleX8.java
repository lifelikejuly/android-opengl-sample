...
public class SampleX8 {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("samplex8/vertex_samplex8.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("samplex8/frag_samplex8.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
