...
public class SampleX2Circle {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex2/vertex_samplex_2.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("samplexs/samplex2/frag_samplex_2.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
