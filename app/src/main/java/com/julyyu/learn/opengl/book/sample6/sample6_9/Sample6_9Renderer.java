package com.julyyu.learn.opengl.book.sample6.sample6_9;
 ...
 */
public class Sample6_9Renderer extends Sample6Renderer {

    private SceneRenderer mRenderer;//场景渲染器
    Ball ball;//球

    public Sample6_9Renderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建球对象
            ball = new Ball(Sample6_9Renderer.this);
            //打开深度检测
