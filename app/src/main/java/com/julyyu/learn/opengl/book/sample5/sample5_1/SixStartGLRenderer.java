package com.julyyu.learn.opengl.book.sample5.sample5_1;
 ...
 */
public class SixStartGLRenderer extends GLSurfaceView {
    ...
    private boolean defluat = true;

    public SixStartGLRenderer(Context context) {
        super(context);
    ...
    public SixStartGLRenderer(Context context, boolean defluat) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            for (int i = 0; i < ha.length; i++) {
                if(defluat){
                    ha[i] = new SixPointedStar(SixStartGLRenderer.this, 0.2f, 0.5f, -0.3f * i);
                }else{
                    ha[i] = new SixPointedStar(SixStartGLRenderer.this, 0.4f, 1.0f, -1.0f * i);
                }
