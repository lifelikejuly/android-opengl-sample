 ...
 * 同时带灰度滤镜
 */
public class TextureMapGLColorEffectView extends GLSurfaceView {
    ...
    public TextureMapGLColorEffectView(Context context) {
        super(context);
        ...
        setRenderer(new Renderer() {
            ...
            public void onSurfaceChanged(GL10 gl, int width, int height) {
                ...
                TextureMapGLColorEffectView.this.width = width;
                TextureMapGLColorEffectView.this.height = height;
