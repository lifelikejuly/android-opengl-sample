...
public class Points {
    ...
    public void initShader(GLSurfaceView mv) {
        // 加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample7/vertex_sample7_9.vsh",
                mv.getResources());
        // 加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample7/frag_sample7_9.fsh",
                mv.getResources());
        // 基于顶点着色器与片元着色器创建程序
