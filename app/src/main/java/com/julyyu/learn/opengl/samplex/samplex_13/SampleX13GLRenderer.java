...
public class SampleX13GLRenderer extends GLSurfaceView {
    ...
    int width = 0;
    int height = 0;
    public SampleX13GLRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            SampleX13GLRenderer.this.width = width;
            SampleX13GLRenderer.this.height = height;
            //设置视窗大小及位置
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new SampleX13(SampleX13GLRenderer.this);
            //初始化纹理
            initTexture();
            //关闭背面剪裁
