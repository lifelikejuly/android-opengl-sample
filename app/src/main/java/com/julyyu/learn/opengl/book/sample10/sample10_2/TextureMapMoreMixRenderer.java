package com.julyyu.learn.opengl.book.sample10.sample10_2;
 ...
 */
public class TextureMapMoreMixRenderer extends GLSurfaceView {
    ...
    public TextureMapMoreMixRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建地球对象
            earth = new Earth(TextureMapMoreMixRenderer.this, 2.0f);
            cloud = new Cloud(TextureMapMoreMixRenderer.this,2.02f);
            //创建月球对象
            moon = new Moon(TextureMapMoreMixRenderer.this, 1.0f);
            //创建小星星天球对象
            cSmall = new Celestial(1, 0, 1000, TextureMapMoreMixRenderer.this);
            //创建大星星天球对象
            cBig = new Celestial(2, 0, 500, TextureMapMoreMixRenderer.this);
            //打开深度检测
