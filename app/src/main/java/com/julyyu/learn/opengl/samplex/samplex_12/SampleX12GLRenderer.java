...
public class SampleX12GLRenderer extends GLSurfaceView {
    ...
    int width = 0;
    int height = 0;
    public SampleX12GLRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements Renderer {
        ...
        public void onSurfaceChanged(GL10 gl, int width, int height) {
            SampleX12GLRenderer.this.width = width;
            SampleX12GLRenderer.this.height = height;
            //设置视窗大小及位置
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三角形对对象
            texRect = new SampleX12(SampleX12GLRenderer.this);
            //初始化纹理
            initTexture();
            //关闭背面剪裁
