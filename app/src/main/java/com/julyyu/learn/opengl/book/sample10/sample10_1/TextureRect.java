...
public class TextureRect {
    ...
    public TextureRect(MixEffectCommonRenderer mv,
    ...
    public void initShader(MixEffectCommonRenderer mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample10/vertex_tex_sample10_1.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample10/frag_tex_sample10_1.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
