...
public class LoadedObjectVertexNormalTexture {
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("vertex_color_sample9_4.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("frag_color_sample9_4.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
