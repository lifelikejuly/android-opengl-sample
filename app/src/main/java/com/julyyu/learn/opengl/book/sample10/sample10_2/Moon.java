...
public class Moon {
    ...
    public Moon(GLSurfaceView mv, float r) {
        //调用初始化顶点数据的方法
        initVertexData(r);
        //调用初始化着色器的方法
        initShader(mv);
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample7/vertex_moon.vsh", mv.getResources());
        ShaderUtil.checkGlError("==ss==");
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample7/frag_moon.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
        ShaderUtil.checkGlError("==ss==");
