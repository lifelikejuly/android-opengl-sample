package com.julyyu.learn.opengl.book.sample7.sample7_7;
 ...
 */
public class TextureMapPointSpriteRenderer extends GLSurfaceView {
    private SceneRenderer mRenderer;//场景渲染器

    public TextureMapPointSpriteRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建点或线对象
            point = new Points(TextureMapPointSpriteRenderer.this);
            //打开深度检测
