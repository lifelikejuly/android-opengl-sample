 ...
 */
public class LoadObjRenderer extends GLSurfaceView {
    ...
    public LoadObjRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //加载要绘制的物体
            lovo = LoadUtil.loadFromFile("book/sample9/ch.obj", LoadObjRenderer.this.getResources(), LoadObjRenderer.this);
        }
    }
}
