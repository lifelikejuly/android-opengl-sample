package com.julyyu.learn.opengl.book.sample7.sample7_3;
 ...
 */
public class TextureMapStretchRenderer extends GLSurfaceView {
    ...
    public TextureMapStretchRenderer(Context context) {
        super(context);
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建三个纹理矩形对对象
            texRect[0] = new TextureRect(TextureMapStretchRenderer.this, 1, 1);
            texRect[1] = new TextureRect(TextureMapStretchRenderer.this, 4, 2);
            texRect[2] = new TextureRect(TextureMapStretchRenderer.this, 4, 4);
            //打开深度检测
    ...
    public int initTexture(int RepeatIndex)//textureId
    {
        ...
        //通过输入流加载图片===============begin===================
        InputStream is = this.getResources().openRawResource(R.raw.robot);
        Bitmap bitmapTmp;
        try {
