package com.julyyu.learn.opengl.book.sample5.sample5_13;
 ...
 */
public class PerspectiveGLRenderer extends GLSurfaceView {
    ...
    public PerspectiveGLRenderer(Context context) {
        super(context);
    ...
    private void change() {
        ...
        if (isChecked) {
            //视角不合适导致变形的情况
            //调用此方法计算产生透视投影矩阵
            MatrixState.setProjectFrustum(-Constant.ratio * 0.7f, Constant.ratio * 0.7f,
                    -0.7f, 0.7f, 1, 10);
            //调用此方法产生摄像机观察矩阵
            MatrixState.setCamera(0, 0.5f, 4,
                    0f, 0f, 0f,
                    0f, 1.0f, 0.0f);
        } else {
            //视角合适不变形的情况
            //调用此方法计算产生透视投影矩阵
            MatrixState.setProjectFrustum(-Constant.ratio, Constant.ratio,
                    -1, 1, 20, 100);
            //调用此方法产生摄像机观察矩阵
            MatrixState.setCamera(0, 8f, 45,
                    0f, 0f, 0f,
                    0f, 1.0f, 0.0f);
        }
    }
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建立方体对象
            cube = new Cube(PerspectiveGLRenderer.this);
            //打开深度检测
