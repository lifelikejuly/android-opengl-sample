package com.julyyu.learn.opengl.book.sample8.sample8_6;
...
public class UtilTools {
    ...
    public ResultData initVertexData(float scale, float aHalf, int n) {
        ...
        alFaceIndex20.add(0);
        alFaceIndex20.add(1);
        alFaceIndex20.add(2);// 1号三角形面坐标索引
        alFaceIndex20.add(0);
        alFaceIndex20.add(2);
        alFaceIndex20.add(3);//2号三角形面坐标索引
        alFaceIndex20.add(0);
        alFaceIndex20.add(3);
        alFaceIndex20.add(4);// 3号三角形面坐标索引
        alFaceIndex20.add(0);
        alFaceIndex20.add(4);
        alFaceIndex20.add(5);//4号三角形面坐标索引
        alFaceIndex20.add(0);
        alFaceIndex20.add(5);
        alFaceIndex20.add(1);// 5号三角形面坐标索引

        alFaceIndex20.add(1);
        alFaceIndex20.add(6);
        alFaceIndex20.add(7);// 6号三角形面坐标索引
        alFaceIndex20.add(1);
        alFaceIndex20.add(7);
        alFaceIndex20.add(2);//7号三角形面坐标索引
        alFaceIndex20.add(2);
        alFaceIndex20.add(7);
        alFaceIndex20.add(8);// 8号三角形面坐标索引
        alFaceIndex20.add(2);
        alFaceIndex20.add(8);
        alFaceIndex20.add(3);// 9号三角形面坐标索引
        alFaceIndex20.add(3);
        alFaceIndex20.add(8);
        alFaceIndex20.add(9);//10号三角形面坐标索引

        alFaceIndex20.add(3);
        alFaceIndex20.add(9);
        alFaceIndex20.add(4);// 11号三角形面坐标索引
        alFaceIndex20.add(4);
        alFaceIndex20.add(9);
        alFaceIndex20.add(10);//12号三角形面坐标索引
        alFaceIndex20.add(4);
        alFaceIndex20.add(10);
        alFaceIndex20.add(5);// 13号三角形面坐标索引
        alFaceIndex20.add(5);
        alFaceIndex20.add(10);
        alFaceIndex20.add(6);// 14号三角形面坐标索引
        alFaceIndex20.add(5);
        alFaceIndex20.add(6);
        alFaceIndex20.add(1);//15号三角形面坐标索引

        alFaceIndex20.add(6);
        alFaceIndex20.add(11);
        alFaceIndex20.add(7);// 16号三角形面坐标索引
        alFaceIndex20.add(7);
        alFaceIndex20.add(11);
        alFaceIndex20.add(8);//17号三角形面坐标索引
        alFaceIndex20.add(8);
        alFaceIndex20.add(11);
        alFaceIndex20.add(9);// 18号三角形面坐标索引
        alFaceIndex20.add(9);
        alFaceIndex20.add(11);
        alFaceIndex20.add(10);// 19号三角形面坐标索引
        alFaceIndex20.add(10);
        alFaceIndex20.add(11);
        alFaceIndex20.add(6);//20号三角形面坐标索引
