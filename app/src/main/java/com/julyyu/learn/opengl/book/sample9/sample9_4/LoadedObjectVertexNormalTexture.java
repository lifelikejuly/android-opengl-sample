...
public class LoadedObjectVertexNormalTexture {
    ...
    public LoadedObjectVertexNormalTexture(GLSurfaceView mv, float[] vertices, float[] normals, float texCoors[]) {//构造器
        //初始化顶点坐标、法向量、纹理坐标数据
    ...
    public void initShader(GLSurfaceView mv) {
        //加载顶点着色器的脚本内容
        mVertexShader = ShaderUtil.loadFromAssetsFile("book/sample9/vertex_color_sample9_4.vsh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader = ShaderUtil.loadFromAssetsFile("book/sample9/frag_color_sample9_4.fsh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序
