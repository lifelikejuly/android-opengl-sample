...
import static com.julyyu.learn.opengl.book.sample11.sample11_5.TextureRect.UNIT_SIZE;
...
public class SkyBoxRenderer extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            //创建纹理矩形对对象 
            texRect = new TextureRect(SkyBoxRenderer.this);
            //加载纹理   
